...
rho = density_from_wigner(xvec, yvec, w, alpha0=0, num_points=2000, num_batches=20, radius=1.2, N=10, fock=False)


sigma_list = [0.05,.1,.5,1]
rho_with_noise_list = []

for sigmas in sigma_list:
    ...
    rho_with_noise_list.append(rho_with_noise)

fidelities = [] 
for rho_reconstructed in rho_with_noise_list:
